...
public class PieChartUI extends JComponent {
    ...
    private final List<PieChart> models;
    ...
    public void addData(PieChart data) {
        models.add(data);
    }

    public void add(PieChart pieChart) {
